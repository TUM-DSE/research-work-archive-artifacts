...
pub fn lift_aarch64_branch_conditional_test(
    builder: &mut InstructionBuilder,
    sequencer: &mut BlockSequencer,
    pc: lift::types::Variable,
    bit_pos: common::types::integer,
    bit_val: common::types::bits,
    datasize: common::types::integer,
    offset: common::types::bits,
    t: common::types::integer,
) -> Result<(), AArch64LifterError> {
    let mut bit_pos: lift::types::Variable = bit_pos.into();
    let mut bit_val: lift::types::Variable = bit_val.into();
