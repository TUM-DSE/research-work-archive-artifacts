...
pub fn lift_aarch64_integer_arithmetic_div(
        ...
        match cond {
            lift::types::Variable::Rust(lift::types::RustVariable::boolean(b_inner)) => {
                if b_inner == common::types::boolean::TRUE {
                    let mut assigns_1: BTreeMap<String, lift::types::AirPackable> = assigns_0
                        .clone();
                    result = lift::types::Variable::from(
                    ...
                    result = {
                        ...
                        lift::helpers::RoundTowardsZero_0(
                            builder,
                            sequencer,
                            pc.clone(),
                            arg_0,
            ...
            lift::types::Variable::Air(a_inner) => {
                ...
                assigns_1
                    .insert(
                        "result".to_string(),
                        lift::types::Variable::from(common::types::integer::from(0))
                            .into(),
                    );
                            ...
                            let arg_0 = {
                                let arg_0 = {
                                    let arg_0 = {
                                        ...
                                        let arg_1 = match assigns_1.get("unsigned") {
                                            Some(packable) => (*packable).clone().try_into()?,
                                            None => unsigned.clone(),
                                        };
