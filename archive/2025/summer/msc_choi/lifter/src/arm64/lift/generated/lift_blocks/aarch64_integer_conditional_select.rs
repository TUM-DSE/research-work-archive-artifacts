...
pub fn lift_aarch64_integer_conditional_select(
    ...
    else_inc: common::types::boolean,
    else_inv: common::types::boolean,
    ...
    let mut else_inc: lift::types::Variable = else_inc.into();
    let mut else_inv: lift::types::Variable = else_inv.into();
    ...
    };
    {
        ...
        match cond {
            lift::types::Variable::Rust(lift::types::RustVariable::boolean(b_inner)) => {
                if b_inner == common::types::boolean::TRUE {
                    let mut assigns_1: BTreeMap<String, lift::types::AirPackable> = assigns_0
                        .clone();
                    result = operand1.clone();
                } else {
                    let mut assigns_1: BTreeMap<String, lift::types::AirPackable> = assigns_0
                        .clone();
                    result = operand2.clone();
                    {
                        let cond = else_inv.clone();
                        match cond {
                            ...
                            lift::types::Variable::Air(a_inner) => {
                                ...
                                assigns_2
                                    .insert(
                                        "result".to_string(),
                                        {
                                            let arg_0 = (match assigns_2.get("result") {
                                ...
                                let (else_args, _): (Vec<Value>, Vec<Type>) = vec![
                                    { let packable : lift::types::AirPackable = result.clone()
                                ...
                                let packable: lift::types::AirPackable = result
                                    .clone()
                                    .into();
            ...
            lift::types::Variable::Air(a_inner) => {
                ...
                {
                    let cond = match assigns_1.get("else_inv") {
                        Some(packable) => (*packable).clone().try_into()?,
                        None => else_inv.clone(),
                    };
                    match cond {
                        lift::types::Variable::Rust(
                            ...
                            if b_inner == common::types::boolean::TRUE {
                                ...
                                assigns_1
                                    .insert(
                                        "result".to_string(),
                                        assigns_2.get("result").unwrap().clone(),
                                    );
                            } else {
                                let mut assigns_2: BTreeMap<
                                    String,
                        ...
                        lift::types::Variable::Air(a_inner) => {
                            ...
                            assigns_1.insert("result".to_string(), packed);
                            consumed_total += consumed;
                        }
                        _ => return Err(AArch64LifterError::VariableNotExpectedEnum),
                    }
                ...
                {
                    let cond = match assigns_1.get("else_inc") {
                        Some(packable) => (*packable).clone().try_into()?,
                        None => else_inc.clone(),
                    };
                    match cond {
