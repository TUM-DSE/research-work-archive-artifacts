...
pub fn lift_aarch64_memory_single_general_register(
    ...
    let mut c: lift::types::Variable = lift::types::Variable::from(
        common::types::Constraint::default(),
    );
    let mut offset: lift::types::Variable = {
        let arg_0 = m.clone();
        let arg_1 = extend_type.clone();
        let arg_2 = shift.clone();
        let arg_3 = lift::types::Variable::from(common::types::integer::from(64));
    ...
    );
    {
        ...
        match cond {
            ...
            lift::types::Variable::Air(a_inner) => {
                ...
                let (then_args, block_param_types): (Vec<Value>, Vec<Type>) = vec![
                    assigns_1.get("c").unwrap().unpack_to_air_values_and_types(builder) ?
                ]
                    .into_iter()
                    .flat_map(|(args, tys): (Vec<Value>, Vec<Type>)| {
                        args.into_iter().zip(tys.into_iter())
                ...
                let mut assigns_1: BTreeMap<String, lift::types::AirPackable> = assigns_0
                    .clone();
                let (else_args, _): (Vec<Value>, Vec<Type>) = vec![
                    { let packable : lift::types::AirPackable = c.clone().into();
    ...
    }
    {
        ...
        match cond {
            ...
            lift::types::Variable::Air(a_inner) => {
                ...
                {
                    let cond = {
                        let arg_0 = match assigns_1.get("memop") {
                            Some(packable) => (*packable).clone().try_into()?,
                            None => memop.clone(),
                        };
                        let arg_1 = lift::types::Variable::from(
                        ...
                        .clone();
                    {
                        ...
                        match cond {
                            ...
                            lift::types::Variable::Air(a_inner) => {
                                ...
                                let mut consumed_total = 0;
                                let packable: lift::types::AirPackable = data
                                    .clone()
                                    .into();
                                let (packed, consumed) = packable
                                    .pack_from_air_values_and_types(
                            ...
                            lift::types::Variable::Air(a_inner) => {
                                ...
                                > = assigns_1.clone();
                                {
                                    let arg_0 = {
                                        ...
                                        let arg_1 = match assigns_2.get("regsize") {
                                            Some(packable) => (*packable).clone().try_into()?,
                                            None => regsize.clone(),
                                        };
                                        ...
                                        let arg_3 = match assigns_2.get("regsize") {
                                            Some(packable) => (*packable).clone().try_into()?,
                                            None => regsize.clone(),
                                        };
                                        lift::helpers::SignExtend_0(
                                    ...
                                    let arg_2 = match assigns_2.get("regsize") {
                                        Some(packable) => (*packable).clone().try_into()?,
                                        None => regsize.clone(),
                                    };
                                    lift::helpers::X_set_0(
