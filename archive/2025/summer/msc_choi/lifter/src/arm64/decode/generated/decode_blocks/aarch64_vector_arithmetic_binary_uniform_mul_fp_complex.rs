...
pub fn decode_aarch64_vector_arithmetic_binary_uniform_mul_fp_complex(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_arithmetic_binary_uniform_mul_fp_complex(
            Box::new(common::types::aarch64_vector_arithmetic_binary_uniform_mul_fp_complex_operands {
                d,
                n,
            }),
        ),
