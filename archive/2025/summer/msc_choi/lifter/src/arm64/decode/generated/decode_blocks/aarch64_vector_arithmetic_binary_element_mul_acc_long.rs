...
pub fn decode_aarch64_vector_arithmetic_binary_element_mul_acc_long(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_arithmetic_binary_element_mul_acc_long(
            Box::new(common::types::aarch64_vector_arithmetic_binary_element_mul_acc_long_operands {
                d,
                n,
            }),
        ),
