...
pub fn decode_aarch64_vector_transfer_vector_extract(
    ...
    let imm4 = common::types::bits::from_bits_literal(
        &reader.extract_slice(11usize, 4usize)?,
    )?;
    ...
    Ok(
        common::types::Instruction::aarch64_vector_transfer_vector_extract(
            Box::new(common::types::aarch64_vector_transfer_vector_extract_operands {
                d,
                n,
            }),
        ),
