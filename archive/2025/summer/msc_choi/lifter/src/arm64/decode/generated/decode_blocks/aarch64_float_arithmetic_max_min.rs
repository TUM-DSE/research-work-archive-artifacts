...
pub fn decode_aarch64_float_arithmetic_max_min(
    ...
    Ok(
        common::types::Instruction::aarch64_float_arithmetic_max_min(
            Box::new(common::types::aarch64_float_arithmetic_max_min_operands {
                d,
                n,
            }),
        ),
