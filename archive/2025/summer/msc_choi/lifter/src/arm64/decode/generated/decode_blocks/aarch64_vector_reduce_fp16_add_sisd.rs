...
pub fn decode_aarch64_vector_reduce_fp16_add_sisd(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_reduce_fp16_add_sisd(
            Box::new(common::types::aarch64_vector_reduce_fp16_add_sisd_operands {
                d,
                n,
            }),
        ),
