...
pub fn decode_aarch64_vector_arithmetic_binary_uniform_mul_int_doubling_accum_sisd(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_arithmetic_binary_uniform_mul_int_doubling_accum_sisd(
            Box::new(common::types::aarch64_vector_arithmetic_binary_uniform_mul_int_doubling_accum_sisd_operands {
                d,
                n,
            }),
        ),
