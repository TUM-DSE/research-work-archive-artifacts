...
pub fn decode_LDFF1B_Z_P_BZ_D_x32_unscaled(
    ...
    Ok(
        common::types::Instruction::LDFF1B_Z_P_BZ_D_x32_unscaled(
            Box::new(common::types::LDFF1B_Z_P_BZ_D_x32_unscaled_operands {
                n,
                t,
            }),
        ),
