...
pub fn decode_aarch64_integer_tags_mcinserttagmask(
    ...
    Ok(
        common::types::Instruction::aarch64_integer_tags_mcinserttagmask(
            Box::new(common::types::aarch64_integer_tags_mcinserttagmask_operands {
                d,
                n,
            }),
        ),
