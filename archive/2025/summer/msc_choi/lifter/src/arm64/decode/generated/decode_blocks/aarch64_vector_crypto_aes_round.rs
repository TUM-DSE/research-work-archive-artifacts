...
pub fn decode_aarch64_vector_crypto_aes_round(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_crypto_aes_round(
            Box::new(common::types::aarch64_vector_crypto_aes_round_operands {
                d,
                n,
            }),
        ),
