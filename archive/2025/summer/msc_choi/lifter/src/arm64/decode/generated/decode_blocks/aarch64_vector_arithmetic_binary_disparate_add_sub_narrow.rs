...
pub fn decode_aarch64_vector_arithmetic_binary_disparate_add_sub_narrow(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_arithmetic_binary_disparate_add_sub_narrow(
            Box::new(common::types::aarch64_vector_arithmetic_binary_disparate_add_sub_narrow_operands {
                d,
                n,
            }),
        ),
