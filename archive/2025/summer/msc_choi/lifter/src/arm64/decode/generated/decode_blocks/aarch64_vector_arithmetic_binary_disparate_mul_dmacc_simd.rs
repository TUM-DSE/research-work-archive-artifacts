...
pub fn decode_aarch64_vector_arithmetic_binary_disparate_mul_dmacc_simd(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_arithmetic_binary_disparate_mul_dmacc_sisd(
            Box::new(common::types::aarch64_vector_arithmetic_binary_disparate_mul_dmacc_sisd_operands {
                d,
                n,
            }),
        ),
