...
pub fn decode_aarch64_vector_crypto_sha512_sha512h2(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_crypto_sha512_sha512h2(
            Box::new(common::types::aarch64_vector_crypto_sha512_sha512h2_operands {
                d,
                n,
            }),
        ),
