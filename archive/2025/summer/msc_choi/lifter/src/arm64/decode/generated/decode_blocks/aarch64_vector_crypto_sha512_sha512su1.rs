...
pub fn decode_aarch64_vector_crypto_sha512_sha512su1(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_crypto_sha512_sha512su1(
            Box::new(common::types::aarch64_vector_crypto_sha512_sha512su1_operands {
                d,
                n,
            }),
        ),
