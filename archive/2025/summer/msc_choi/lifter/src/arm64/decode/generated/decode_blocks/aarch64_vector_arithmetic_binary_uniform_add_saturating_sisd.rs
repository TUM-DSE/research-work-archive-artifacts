...
pub fn decode_aarch64_vector_arithmetic_binary_uniform_add_saturating_sisd(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_arithmetic_binary_uniform_add_saturating_sisd(
            Box::new(common::types::aarch64_vector_arithmetic_binary_uniform_add_saturating_sisd_operands {
                d,
                n,
            }),
        ),
