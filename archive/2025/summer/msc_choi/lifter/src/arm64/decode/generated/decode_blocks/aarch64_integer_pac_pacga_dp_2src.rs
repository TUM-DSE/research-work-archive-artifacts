...
pub fn decode_aarch64_integer_pac_pacga_dp_2src(
    ...
    Ok(
        common::types::Instruction::aarch64_integer_pac_pacga_dp_2src(
            Box::new(common::types::aarch64_integer_pac_pacga_dp_2src_operands {
                d,
                n,
            }),
        ),
