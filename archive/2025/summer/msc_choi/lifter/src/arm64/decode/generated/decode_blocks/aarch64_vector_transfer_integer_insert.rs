...
pub fn decode_aarch64_vector_transfer_integer_insert(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_transfer_integer_insert(
            Box::new(common::types::aarch64_vector_transfer_integer_insert_operands {
                d,
                n,
            }),
        ),
