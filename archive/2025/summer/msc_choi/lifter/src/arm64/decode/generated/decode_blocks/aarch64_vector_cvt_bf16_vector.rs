...
pub fn decode_aarch64_vector_cvt_bf16_vector(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_cvt_bf16_vector(
            Box::new(common::types::aarch64_vector_cvt_bf16_vector_operands {
                d,
                n,
            }),
        ),
