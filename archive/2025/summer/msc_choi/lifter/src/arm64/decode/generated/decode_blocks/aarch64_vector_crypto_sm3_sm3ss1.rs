...
pub fn decode_aarch64_vector_crypto_sm3_sm3ss1(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_crypto_sm3_sm3ss1(
            Box::new(common::types::aarch64_vector_crypto_sm3_sm3ss1_operands {
                d,
                n,
            }),
        ),
