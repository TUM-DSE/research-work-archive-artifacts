...
pub fn decode_aarch64_memory_exclusive_pair(
    ...
    Ok(
        common::types::Instruction::aarch64_memory_exclusive_pair(
            Box::new(common::types::aarch64_memory_exclusive_pair_operands {
                n,
                s,
                t,
                t2,
