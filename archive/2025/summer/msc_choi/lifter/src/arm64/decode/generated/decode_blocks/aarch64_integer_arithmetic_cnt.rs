...
pub fn decode_aarch64_integer_arithmetic_cnt(
    ...
    let mut opcode: common::types::CountOp = if (decode::helpers::eq_bits_0(
        op,
        common::types::bits::from_bits_literal("0")?,
        common::types::integer::from(1),
    )?) == common::types::boolean::TRUE
    {
        common::types::CountOp::CountOp_CLZ
    } else {
        common::types::CountOp::CountOp_CLS
    };
    Ok(
        common::types::Instruction::aarch64_integer_arithmetic_cnt(
            Box::new(common::types::aarch64_integer_arithmetic_cnt_operands {
                d,
                datasize,
                n,
                opcode,
