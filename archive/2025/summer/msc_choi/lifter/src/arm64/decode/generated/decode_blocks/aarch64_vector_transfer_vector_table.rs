...
pub fn decode_aarch64_vector_transfer_vector_table(
    ...
    let len = common::types::bits::from_bits_literal(
        &reader.extract_slice(13usize, 2usize)?,
    )?;
    ...
    Ok(
        common::types::Instruction::aarch64_vector_transfer_vector_table(
            Box::new(common::types::aarch64_vector_transfer_vector_table_operands {
                d,
                n,
            }),
        ),
