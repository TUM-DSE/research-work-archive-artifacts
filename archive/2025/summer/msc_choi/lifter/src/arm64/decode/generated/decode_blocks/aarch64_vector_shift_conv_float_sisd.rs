...
pub fn decode_aarch64_vector_shift_conv_float_sisd(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_shift_conv_float_sisd(
            Box::new(common::types::aarch64_vector_shift_conv_float_sisd_operands {
                d,
                n,
            }),
        ),
