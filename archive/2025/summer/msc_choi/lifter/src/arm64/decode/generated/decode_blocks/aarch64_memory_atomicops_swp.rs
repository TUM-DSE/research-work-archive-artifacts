...
pub fn decode_aarch64_memory_atomicops_swp(
    ...
    Ok(
        common::types::Instruction::aarch64_memory_atomicops_swp(
            Box::new(common::types::aarch64_memory_atomicops_swp_operands {
                n,
                s,
                t,
            }),
