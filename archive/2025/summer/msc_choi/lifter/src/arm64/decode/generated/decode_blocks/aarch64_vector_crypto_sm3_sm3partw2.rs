...
pub fn decode_aarch64_vector_crypto_sm3_sm3partw2(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_crypto_sm3_sm3partw2(
            Box::new(common::types::aarch64_vector_crypto_sm3_sm3partw2_operands {
                d,
                n,
            }),
        ),
