...
pub fn decode_aarch64_integer_tags_mcsettagarray(
    ...
    Ok(
        common::types::Instruction::aarch64_integer_tags_mcsettagarray(
            Box::new(common::types::aarch64_integer_tags_mcsettagarray_operands {
                n,
                t,
            }),
        ),
