...
pub fn decode_aarch64_vector_arithmetic_binary_uniform_sub_fp16_sisd(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_arithmetic_binary_uniform_sub_fp16_sisd(
            Box::new(common::types::aarch64_vector_arithmetic_binary_uniform_sub_fp16_sisd_operands {
                d,
                n,
            }),
        ),
