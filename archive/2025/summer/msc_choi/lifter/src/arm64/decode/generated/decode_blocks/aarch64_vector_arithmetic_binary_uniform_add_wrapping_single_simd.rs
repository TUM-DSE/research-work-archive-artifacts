...
pub fn decode_aarch64_vector_arithmetic_binary_uniform_add_wrapping_single_simd(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_arithmetic_binary_uniform_add_wrapping_single_sisd(
            Box::new(common::types::aarch64_vector_arithmetic_binary_uniform_add_wrapping_single_sisd_operands {
                d,
                n,
            }),
        ),
