...
pub fn decode_aarch64_vector_arithmetic_unary_cnt(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_arithmetic_unary_cnt(
            Box::new(common::types::aarch64_vector_arithmetic_unary_cnt_operands {
                d,
                n,
            }),
        ),
