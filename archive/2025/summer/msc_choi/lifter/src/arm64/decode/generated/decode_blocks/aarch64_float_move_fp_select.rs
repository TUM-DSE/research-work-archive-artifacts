...
pub fn decode_aarch64_float_move_fp_select(
    ...
    Ok(
        common::types::Instruction::aarch64_float_move_fp_select(
            Box::new(common::types::aarch64_float_move_fp_select_operands {
                d,
                n,
            }),
        ),
