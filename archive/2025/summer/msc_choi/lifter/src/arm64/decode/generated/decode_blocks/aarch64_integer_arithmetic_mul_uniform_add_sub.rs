...
pub fn decode_aarch64_integer_arithmetic_mul_uniform_add_sub(
    ...
    let mut destsize: common::types::integer = if (decode::helpers::eq_bits_0(
        sf,
    ...
    let mut datasize: common::types::integer = destsize.clone();
    ...
    Ok(
        common::types::Instruction::aarch64_integer_arithmetic_mul_uniform_add_sub(
            Box::new(common::types::aarch64_integer_arithmetic_mul_uniform_add_sub_operands {
                a,
                d,
                datasize,
                destsize,
