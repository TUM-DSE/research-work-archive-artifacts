...
pub fn decode_aarch64_vector_reduce_add_simd(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_reduce_add_simd(
            Box::new(common::types::aarch64_vector_reduce_add_simd_operands {
                d,
                n,
            }),
        ),
