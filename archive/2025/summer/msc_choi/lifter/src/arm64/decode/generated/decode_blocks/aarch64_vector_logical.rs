...
pub fn decode_aarch64_vector_logical(
    ...
    let cmode = common::types::bits::from_bits_literal(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_logical(
            Box::new(common::types::aarch64_vector_logical_operands {
            }),
        ),
    )
}
