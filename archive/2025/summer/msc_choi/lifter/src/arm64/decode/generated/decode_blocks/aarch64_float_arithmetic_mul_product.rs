...
pub fn decode_aarch64_float_arithmetic_mul_product(
    ...
    Ok(
        common::types::Instruction::aarch64_float_arithmetic_mul_product(
            Box::new(common::types::aarch64_float_arithmetic_mul_product_operands {
                d,
                n,
            }),
        ),
