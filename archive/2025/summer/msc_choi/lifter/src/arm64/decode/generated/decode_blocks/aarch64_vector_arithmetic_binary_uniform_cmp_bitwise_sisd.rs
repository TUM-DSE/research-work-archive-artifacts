...
pub fn decode_aarch64_vector_arithmetic_binary_uniform_cmp_bitwise_sisd(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_arithmetic_binary_uniform_cmp_bitwise_sisd(
            Box::new(common::types::aarch64_vector_arithmetic_binary_uniform_cmp_bitwise_sisd_operands {
                d,
                n,
            }),
        ),
