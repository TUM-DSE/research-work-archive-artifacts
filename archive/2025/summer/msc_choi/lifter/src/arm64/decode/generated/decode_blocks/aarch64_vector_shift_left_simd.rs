...
pub fn decode_aarch64_vector_shift_left_simd(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_shift_left_sisd(
            Box::new(common::types::aarch64_vector_shift_left_sisd_operands {
                d,
                n,
            }),
        ),
