...
pub fn decode_aarch64_vector_transfer_vector_insert(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_transfer_vector_insert(
            Box::new(common::types::aarch64_vector_transfer_vector_insert_operands {
                d,
                n,
            }),
        ),
