...
pub fn decode_aarch64_vector_arithmetic_binary_disparate_add_sub_wide(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_arithmetic_binary_disparate_add_sub_wide(
            Box::new(common::types::aarch64_vector_arithmetic_binary_disparate_add_sub_wide_operands {
                d,
                n,
            }),
        ),
