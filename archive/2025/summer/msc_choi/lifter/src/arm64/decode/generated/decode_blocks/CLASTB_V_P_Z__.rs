...
pub fn decode_CLASTB_V_P_Z__(
    ...
    let Vdn = common::types::bits::from_bits_literal(
    ...
    Ok(
        common::types::Instruction::CLASTB_V_P_Z__(
            Box::new(common::types::CLASTB_V_P_Z___operands {
                dn,
            }),
        ),
    )
