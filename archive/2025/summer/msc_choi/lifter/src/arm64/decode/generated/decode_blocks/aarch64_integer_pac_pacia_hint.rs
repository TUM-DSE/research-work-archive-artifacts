...
pub fn decode_aarch64_integer_pac_pacia_hint(
    ...
    if (decode::helpers::append_bits_0(
        ...
        .match_with_pattern("0011 000")) && true
    {
        ...
        .match_with_pattern("0011 001")) && true
    {
        d = common::types::integer::from(30);
    } else if (decode::helpers::append_bits_0(
            CRm,
    ...
    Ok(
        common::types::Instruction::aarch64_integer_pac_pacia_dp_1src(
            Box::new(common::types::aarch64_integer_pac_pacia_dp_1src_operands {
                d,
                n,
            }),
        ),
