...
pub fn decode_aarch64_vector_arithmetic_binary_disparate_mul_product(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_arithmetic_binary_disparate_mul_product(
            Box::new(common::types::aarch64_vector_arithmetic_binary_disparate_mul_product_operands {
                d,
                n,
            }),
        ),
