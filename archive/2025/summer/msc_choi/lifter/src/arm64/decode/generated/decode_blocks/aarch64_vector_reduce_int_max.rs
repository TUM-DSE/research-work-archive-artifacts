...
pub fn decode_aarch64_vector_reduce_int_max(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_reduce_int_max(
            Box::new(common::types::aarch64_vector_reduce_int_max_operands {
                d,
                n,
            }),
        ),
