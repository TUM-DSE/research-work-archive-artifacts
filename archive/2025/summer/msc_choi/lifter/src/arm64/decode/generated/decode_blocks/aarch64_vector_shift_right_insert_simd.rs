...
pub fn decode_aarch64_vector_shift_right_insert_simd(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_shift_right_insert_sisd(
            Box::new(common::types::aarch64_vector_shift_right_insert_sisd_operands {
                d,
                n,
            }),
        ),
