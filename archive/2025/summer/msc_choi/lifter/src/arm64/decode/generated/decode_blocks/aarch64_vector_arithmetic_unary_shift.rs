...
pub fn decode_aarch64_vector_arithmetic_unary_shift(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_arithmetic_unary_shift(
            Box::new(common::types::aarch64_vector_arithmetic_unary_shift_operands {
                d,
                n,
            }),
        ),
