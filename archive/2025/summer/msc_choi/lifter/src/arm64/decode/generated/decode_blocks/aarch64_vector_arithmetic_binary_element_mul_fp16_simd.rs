...
pub fn decode_aarch64_vector_arithmetic_binary_element_mul_fp16_simd(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_arithmetic_binary_element_mul_fp16_sisd(
            Box::new(common::types::aarch64_vector_arithmetic_binary_element_mul_fp16_sisd_operands {
                d,
                n,
            }),
        ),
