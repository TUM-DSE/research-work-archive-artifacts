...
pub fn decode_aarch64_float_arithmetic_add_sub(
    ...
    Ok(
        common::types::Instruction::aarch64_float_arithmetic_add_sub(
            Box::new(common::types::aarch64_float_arithmetic_add_sub_operands {
                d,
                n,
            }),
        ),
