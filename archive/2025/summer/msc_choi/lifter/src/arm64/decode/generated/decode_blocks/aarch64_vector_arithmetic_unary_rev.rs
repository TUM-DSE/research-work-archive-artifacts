...
pub fn decode_aarch64_vector_arithmetic_unary_rev(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_arithmetic_unary_rev(
            Box::new(common::types::aarch64_vector_arithmetic_unary_rev_operands {
                d,
                n,
            }),
        ),
