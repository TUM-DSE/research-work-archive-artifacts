...
pub fn decode_aarch64_vector_arithmetic_binary_uniform_max_min_fp16_1985(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_arithmetic_binary_uniform_max_min_fp16_1985(
            Box::new(common::types::aarch64_vector_arithmetic_binary_uniform_max_min_fp16_1985_operands {
                d,
                n,
            }),
        ),
