...
pub fn decode_aarch64_vector_crypto_aes_mix(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_crypto_aes_mix(
            Box::new(common::types::aarch64_vector_crypto_aes_mix_operands {
                d,
                n,
            }),
        ),
