...
pub fn decode_aarch64_vector_crypto_sm3_sm3tt2a(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_crypto_sm3_sm3tt2a(
            Box::new(common::types::aarch64_vector_crypto_sm3_sm3tt2a_operands {
                d,
                n,
            }),
        ),
