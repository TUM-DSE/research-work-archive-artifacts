...
pub fn decode_aarch64_vector_arithmetic_binary_uniform_logical_bsl_eor(
    reader: &mut decode::BitReader,
) -> Result<common::types::Instruction, AArch64LifterError> {
    let Q = common::types::bits::from_bits_literal(
        &reader.extract_slice(30usize, 1usize)?,
    )?;
    let opc2 = common::types::bits::from_bits_literal(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_arithmetic_binary_uniform_logical_bsl_eor(
            Box::new(common::types::aarch64_vector_arithmetic_binary_uniform_logical_bsl_eor_operands {
                d,
                n,
            }),
        ),
