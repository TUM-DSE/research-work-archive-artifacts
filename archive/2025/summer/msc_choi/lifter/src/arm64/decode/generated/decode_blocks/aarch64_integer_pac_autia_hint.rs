...
pub fn decode_aarch64_integer_pac_autia_hint(
    ...
    if (decode::helpers::append_bits_0(
        ...
        .match_with_pattern("0011 100")) && true
    {
        ...
        .match_with_pattern("0011 101")) && true
    {
        d = common::types::integer::from(30);
    } else if (decode::helpers::append_bits_0(
            CRm,
    ...
    {
        return Ok(
            decode::generated::decode_blocks::decode_aarch64_integer_pac_autib_dp_1src(
                reader,
            )?,
        );
    } else if (decode::helpers::append_bits_0(
        ...
        .match_with_pattern("0011 01x")) && true
    {
        ...
        .match_with_pattern("0011 11x")) && true
    {
        return Ok(
            decode::generated::decode_blocks::decode_aarch64_integer_pac_autib_dp_1src(
                reader,
    ...
    Ok(
        common::types::Instruction::aarch64_integer_pac_autia_dp_1src(
            Box::new(common::types::aarch64_integer_pac_autia_dp_1src_operands {
                d,
                n,
            }),
        ),
