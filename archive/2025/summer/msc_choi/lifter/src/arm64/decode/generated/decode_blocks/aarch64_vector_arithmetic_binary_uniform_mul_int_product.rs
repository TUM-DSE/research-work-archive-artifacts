...
pub fn decode_aarch64_vector_arithmetic_binary_uniform_mul_int_product(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_arithmetic_binary_uniform_mul_int_product(
            Box::new(common::types::aarch64_vector_arithmetic_binary_uniform_mul_int_product_operands {
                d,
                n,
            }),
        ),
