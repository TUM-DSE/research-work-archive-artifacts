...
pub fn decode_aarch64_vector_arithmetic_unary_not(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_arithmetic_unary_not(
            Box::new(common::types::aarch64_vector_arithmetic_unary_not_operands {
                d,
                n,
            }),
        ),
