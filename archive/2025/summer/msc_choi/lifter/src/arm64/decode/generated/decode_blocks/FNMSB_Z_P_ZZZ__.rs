...
pub fn decode_FNMSB_Z_P_ZZZ__(
    ...
    Ok(
        common::types::Instruction::FNMSB_Z_P_ZZZ__(
            Box::new(common::types::FNMSB_Z_P_ZZZ___operands {
                dn,
            }),
        ),
    )
