...
pub fn decode_aarch64_float_arithmetic_div(
    ...
    Ok(
        common::types::Instruction::aarch64_float_arithmetic_div(
            Box::new(common::types::aarch64_float_arithmetic_div_operands {
                d,
                n,
            }),
        ),
