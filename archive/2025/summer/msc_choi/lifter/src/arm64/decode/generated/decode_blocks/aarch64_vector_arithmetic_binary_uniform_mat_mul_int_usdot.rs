...
pub fn decode_aarch64_vector_arithmetic_binary_uniform_mat_mul_int_usdot(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_arithmetic_binary_uniform_mat_mul_int_usdot(
            Box::new(common::types::aarch64_vector_arithmetic_binary_uniform_mat_mul_int_usdot_operands {
                d,
                n,
            }),
        ),
