...
pub fn decode_aarch64_vector_arithmetic_binary_uniform_cmp_fp16_simd(
    ...
    let ac = common::types::bits::from_bits_literal(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_arithmetic_binary_uniform_cmp_fp16_sisd(
            Box::new(common::types::aarch64_vector_arithmetic_binary_uniform_cmp_fp16_sisd_operands {
                d,
                n,
            }),
        ),
