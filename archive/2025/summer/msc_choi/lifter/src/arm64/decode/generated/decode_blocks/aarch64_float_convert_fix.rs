...
pub fn decode_aarch64_float_convert_fix(
    ...
    let scale = common::types::bits::from_bits_literal(
    ...
    Ok(
        common::types::Instruction::aarch64_float_convert_fix(
            Box::new(common::types::aarch64_float_convert_fix_operands {
                d,
                n,
            }),
        ),
