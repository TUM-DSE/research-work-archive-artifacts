...
pub fn decode_LDFF1SW_Z_P_BZ_D_x32_unscaled(
    ...
    Ok(
        common::types::Instruction::LDFF1SW_Z_P_BZ_D_x32_scaled(
            Box::new(common::types::LDFF1SW_Z_P_BZ_D_x32_scaled_operands {
                n,
                t,
            }),
        ),
