...
pub fn decode_aarch64_vector_reduce_add_long(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_reduce_add_long(
            Box::new(common::types::aarch64_vector_reduce_add_long_operands {
                d,
                n,
            }),
        ),
