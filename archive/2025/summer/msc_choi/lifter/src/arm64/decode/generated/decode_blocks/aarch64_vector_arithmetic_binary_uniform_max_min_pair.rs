...
pub fn decode_aarch64_vector_arithmetic_binary_uniform_max_min_pair(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_arithmetic_binary_uniform_max_min_pair(
            Box::new(common::types::aarch64_vector_arithmetic_binary_uniform_max_min_pair_operands {
                d,
                n,
            }),
        ),
