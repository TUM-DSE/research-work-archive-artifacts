...
pub fn decode_PFIRST_P_P_P__(
    ...
    Ok(
        common::types::Instruction::PFIRST_P_P_P__(
            Box::new(common::types::PFIRST_P_P_P___operands {
                dn,
            }),
        ),
    )
