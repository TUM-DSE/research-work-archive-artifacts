...
pub fn decode_aarch64_vector_crypto_sha512_sha512su0(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_crypto_sha512_sha512su0(
            Box::new(common::types::aarch64_vector_crypto_sha512_sha512su0_operands {
                d,
                n,
            }),
        ),
