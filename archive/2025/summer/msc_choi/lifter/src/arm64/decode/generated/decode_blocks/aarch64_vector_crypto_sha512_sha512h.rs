...
pub fn decode_aarch64_vector_crypto_sha512_sha512h(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_crypto_sha512_sha512h(
            Box::new(common::types::aarch64_vector_crypto_sha512_sha512h_operands {
                d,
                n,
            }),
        ),
