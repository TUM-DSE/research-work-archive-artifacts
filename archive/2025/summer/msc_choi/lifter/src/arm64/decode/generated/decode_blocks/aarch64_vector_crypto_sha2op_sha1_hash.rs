...
pub fn decode_aarch64_vector_crypto_sha2op_sha1_hash(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_crypto_sha2op_sha1_hash(
            Box::new(common::types::aarch64_vector_crypto_sha2op_sha1_hash_operands {
                d,
                n,
            }),
        ),
