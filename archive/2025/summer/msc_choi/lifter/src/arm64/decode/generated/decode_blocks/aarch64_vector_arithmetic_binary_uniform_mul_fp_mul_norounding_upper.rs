...
pub fn decode_aarch64_vector_arithmetic_binary_uniform_mul_fp_mul_norounding_upper(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_arithmetic_binary_uniform_mul_fp_mul_norounding_lower(
            Box::new(common::types::aarch64_vector_arithmetic_binary_uniform_mul_fp_mul_norounding_lower_operands {
                d,
                n,
            }),
        ),
