...
pub fn decode_aarch64_memory_single_general_immediate_signed_offset_lda_stl(
    ...
    Ok(
        common::types::Instruction::aarch64_memory_single_general_immediate_signed_offset_lda_stl(
            Box::new(common::types::aarch64_memory_single_general_immediate_signed_offset_lda_stl_operands {
                n,
                t,
            }),
        ),
