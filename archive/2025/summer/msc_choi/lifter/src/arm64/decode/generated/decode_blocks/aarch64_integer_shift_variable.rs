...
pub fn decode_aarch64_integer_shift_variable(
    ...
    let mut shift_type: common::types::ShiftType = decode::helpers::DecodeShift_0(op2)?;
    Ok(
        common::types::Instruction::aarch64_integer_shift_variable(
            Box::new(common::types::aarch64_integer_shift_variable_operands {
                d,
                datasize,
                m,
                n,
