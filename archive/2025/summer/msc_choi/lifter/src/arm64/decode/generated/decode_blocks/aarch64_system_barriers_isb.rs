...
pub fn decode_aarch64_system_barriers_isb(
    ...
    Ok(
        common::types::Instruction::aarch64_system_barriers_isb(
            Box::new(common::types::aarch64_system_barriers_isb_operands {
            }),
        ),
    )
}
