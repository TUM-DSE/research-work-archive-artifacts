...
pub fn decode_aarch64_memory_single_general_immediate_signed_offset_unpriv(
    ...
    Ok(
        common::types::Instruction::aarch64_memory_single_general_immediate_signed_offset_unpriv(
            Box::new(common::types::aarch64_memory_single_general_immediate_signed_offset_unpriv_operands {
                n,
                t,
            }),
        ),
