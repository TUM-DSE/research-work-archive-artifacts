...
pub fn decode_aarch64_vector_arithmetic_unary_clsz(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_arithmetic_unary_clsz(
            Box::new(common::types::aarch64_vector_arithmetic_unary_clsz_operands {
                d,
                n,
            }),
        ),
