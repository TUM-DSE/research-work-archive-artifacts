...
pub fn decode_aarch64_vector_crypto_sm4_sm4enc(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_crypto_sm4_sm4enc(
            Box::new(common::types::aarch64_vector_crypto_sm4_sm4enc_operands {
                d,
                n,
            }),
        ),
