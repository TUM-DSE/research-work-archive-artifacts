...
pub fn decode_aarch64_vector_reduce_fp16_max_simd(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_reduce_fp16_max_simd(
            Box::new(common::types::aarch64_vector_reduce_fp16_max_simd_operands {
                d,
                n,
            }),
        ),
