...
pub fn decode_aarch64_vector_arithmetic_binary_element_mat_mul_int_dotp(
    reader: &mut decode::BitReader,
) -> Result<common::types::Instruction, AArch64LifterError> {
    let Q = common::types::bits::from_bits_literal(
        &reader.extract_slice(30usize, 1usize)?,
    )?;
    let US = common::types::bits::from_bits_literal(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_arithmetic_binary_element_mat_mul_int_dotp(
            Box::new(common::types::aarch64_vector_arithmetic_binary_element_mat_mul_int_dotp_operands {
                d,
                n,
            }),
        ),
