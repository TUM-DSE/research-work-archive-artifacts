...
pub fn decode_aarch64_integer_tags_mcgettagarray(
    ...
    Ok(
        common::types::Instruction::aarch64_integer_tags_mcgettagarray(
            Box::new(common::types::aarch64_integer_tags_mcgettagarray_operands {
                n,
                t,
            }),
        ),
