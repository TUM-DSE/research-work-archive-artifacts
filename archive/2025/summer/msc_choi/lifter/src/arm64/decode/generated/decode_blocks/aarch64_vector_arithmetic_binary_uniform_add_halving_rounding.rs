...
pub fn decode_aarch64_vector_arithmetic_binary_uniform_add_halving_rounding(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_arithmetic_binary_uniform_add_halving_rounding(
            Box::new(common::types::aarch64_vector_arithmetic_binary_uniform_add_halving_rounding_operands {
                d,
                n,
            }),
        ),
