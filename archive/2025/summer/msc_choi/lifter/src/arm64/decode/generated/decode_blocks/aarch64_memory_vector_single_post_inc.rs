...
pub fn decode_aarch64_memory_vector_single_post_inc(
    ...
    Ok(
        common::types::Instruction::aarch64_memory_vector_single_no_wb(
            Box::new(common::types::aarch64_memory_vector_single_no_wb_operands {
                n,
                t,
            }),
        ),
