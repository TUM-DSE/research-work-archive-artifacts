...
pub fn decode_aarch64_vector_shift_left_insert_sisd(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_shift_left_insert_sisd(
            Box::new(common::types::aarch64_vector_shift_left_insert_sisd_operands {
                d,
                n,
            }),
        ),
