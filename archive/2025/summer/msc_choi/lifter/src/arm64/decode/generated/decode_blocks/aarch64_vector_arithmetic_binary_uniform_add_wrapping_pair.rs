...
pub fn decode_aarch64_vector_arithmetic_binary_uniform_add_wrapping_pair(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_arithmetic_binary_uniform_add_wrapping_pair(
            Box::new(common::types::aarch64_vector_arithmetic_binary_uniform_add_wrapping_pair_operands {
                d,
                n,
            }),
        ),
