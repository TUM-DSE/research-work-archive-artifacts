...
pub fn decode_LD1SB_Z_P_BZ_D_x32_unscaled(
    ...
    Ok(
        common::types::Instruction::LD1SB_Z_P_BZ_D_x32_unscaled(
            Box::new(common::types::LD1SB_Z_P_BZ_D_x32_unscaled_operands {
                n,
                t,
            }),
        ),
