...
pub fn decode_aarch64_vector_crypto_sha3op_sha256_hash(
    reader: &mut decode::BitReader,
) -> Result<common::types::Instruction, AArch64LifterError> {
    let Rm = common::types::bits::from_bits_literal(
        &reader.extract_slice(16usize, 5usize)?,
    )?;
    let P = common::types::bits::from_bits_literal(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_crypto_sha3op_sha256_hash(
            Box::new(common::types::aarch64_vector_crypto_sha3op_sha256_hash_operands {
                d,
                n,
            }),
        ),
