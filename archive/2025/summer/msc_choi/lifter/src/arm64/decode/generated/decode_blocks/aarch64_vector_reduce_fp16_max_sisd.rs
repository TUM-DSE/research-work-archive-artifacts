...
pub fn decode_aarch64_vector_reduce_fp16_max_sisd(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_reduce_fp16_max_sisd(
            Box::new(common::types::aarch64_vector_reduce_fp16_max_sisd_operands {
                d,
                n,
            }),
        ),
