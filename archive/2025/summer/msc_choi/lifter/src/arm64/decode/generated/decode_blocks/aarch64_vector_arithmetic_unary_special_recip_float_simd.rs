...
pub fn decode_aarch64_vector_arithmetic_unary_special_recip_float_simd(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_arithmetic_unary_special_recip_fp16_sisd(
            Box::new(common::types::aarch64_vector_arithmetic_unary_special_recip_fp16_sisd_operands {
                d,
                n,
            }),
        ),
