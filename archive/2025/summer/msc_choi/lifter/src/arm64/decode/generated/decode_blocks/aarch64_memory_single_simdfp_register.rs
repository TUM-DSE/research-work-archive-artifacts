...
pub fn decode_aarch64_memory_single_simdfp_register(
    ...
    Ok(
        common::types::Instruction::aarch64_memory_single_simdfp_register(
            Box::new(common::types::aarch64_memory_single_simdfp_register_operands {
                n,
                t,
            }),
        ),
