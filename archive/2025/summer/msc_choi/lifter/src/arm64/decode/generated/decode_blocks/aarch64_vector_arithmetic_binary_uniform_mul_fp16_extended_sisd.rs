...
pub fn decode_aarch64_vector_arithmetic_binary_uniform_mul_fp16_extended_sisd(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_arithmetic_binary_uniform_mul_fp16_extended_sisd(
            Box::new(common::types::aarch64_vector_arithmetic_binary_uniform_mul_fp16_extended_sisd_operands {
                d,
                n,
            }),
        ),
