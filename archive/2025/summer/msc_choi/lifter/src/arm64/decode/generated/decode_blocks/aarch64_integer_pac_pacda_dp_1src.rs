...
pub fn decode_aarch64_integer_pac_pacda_dp_1src(
    ...
    Ok(
        common::types::Instruction::aarch64_integer_pac_pacda_dp_1src(
            Box::new(common::types::aarch64_integer_pac_pacda_dp_1src_operands {
                d,
                n,
            }),
        ),
