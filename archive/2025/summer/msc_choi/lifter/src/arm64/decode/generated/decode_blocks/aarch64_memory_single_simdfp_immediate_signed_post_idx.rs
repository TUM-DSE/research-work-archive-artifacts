...
pub fn decode_aarch64_memory_single_simdfp_immediate_signed_post_idx(
    ...
    Ok(
        common::types::Instruction::aarch64_memory_single_simdfp_immediate_signed_post_idx(
            Box::new(common::types::aarch64_memory_single_simdfp_immediate_signed_post_idx_operands {
                n,
                t,
            }),
        ),
