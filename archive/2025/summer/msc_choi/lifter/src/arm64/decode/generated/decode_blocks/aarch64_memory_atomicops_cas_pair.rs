...
pub fn decode_aarch64_memory_atomicops_cas_pair(
    ...
    Ok(
        common::types::Instruction::aarch64_memory_atomicops_cas_pair(
            Box::new(common::types::aarch64_memory_atomicops_cas_pair_operands {
                n,
                s,
                t,
            }),
