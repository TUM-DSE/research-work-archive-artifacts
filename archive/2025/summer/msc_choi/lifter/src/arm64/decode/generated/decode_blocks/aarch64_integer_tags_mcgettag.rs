...
pub fn decode_aarch64_integer_tags_mcgettag(
    ...
    Ok(
        common::types::Instruction::aarch64_integer_tags_mcgettag(
            Box::new(common::types::aarch64_integer_tags_mcgettag_operands {
                n,
                t,
            }),
        ),
