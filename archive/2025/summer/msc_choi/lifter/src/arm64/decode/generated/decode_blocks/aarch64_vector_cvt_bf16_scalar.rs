...
pub fn decode_aarch64_vector_cvt_bf16_scalar(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_cvt_bf16_scalar(
            Box::new(common::types::aarch64_vector_cvt_bf16_scalar_operands {
                d,
                n,
            }),
        ),
