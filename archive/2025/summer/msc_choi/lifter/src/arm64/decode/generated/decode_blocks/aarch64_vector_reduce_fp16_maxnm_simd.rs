...
pub fn decode_aarch64_vector_reduce_fp16_maxnm_simd(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_reduce_fp16_maxnm_simd(
            Box::new(common::types::aarch64_vector_reduce_fp16_maxnm_simd_operands {
                d,
                n,
            }),
        ),
