...
pub fn decode_aarch64_vector_arithmetic_binary_element_mul_acc_complex(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_arithmetic_binary_element_mul_acc_complex(
            Box::new(common::types::aarch64_vector_arithmetic_binary_element_mul_acc_complex_operands {
                d,
                n,
            }),
        ),
