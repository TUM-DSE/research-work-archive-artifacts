...
pub fn decode_aarch64_memory_single_general_immediate_signed_offset_normal(
    ...
    Ok(
        common::types::Instruction::aarch64_memory_single_general_immediate_signed_offset_normal(
            Box::new(common::types::aarch64_memory_single_general_immediate_signed_offset_normal_operands {
                acctype,
                datasize,
                memop,
                n,
