...
pub fn decode_aarch64_integer_tags_mcsettagpairpost(
    ...
    Ok(
        common::types::Instruction::aarch64_integer_tags_mcsettagpairpost(
            Box::new(common::types::aarch64_integer_tags_mcsettagpairpost_operands {
                n,
                t,
            }),
        ),
