...
pub fn decode_aarch64_vector_reduce_fp16_maxnm_sisd(
    reader: &mut decode::BitReader,
) -> Result<common::types::Instruction, AArch64LifterError> {
    let o1 = common::types::bits::from_bits_literal(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_reduce_fp16_maxnm_sisd(
            Box::new(common::types::aarch64_vector_reduce_fp16_maxnm_sisd_operands {
                d,
                n,
            }),
        ),
