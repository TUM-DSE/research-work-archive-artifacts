...
pub fn decode_aarch64_vector_arithmetic_binary_uniform_mul_acc_bf16_long(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_arithmetic_binary_uniform_mul_acc_bf16_long(
            Box::new(common::types::aarch64_vector_arithmetic_binary_uniform_mul_acc_bf16_long_operands {
                d,
                n,
            }),
        ),
