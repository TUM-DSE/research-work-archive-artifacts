...
pub fn decode_aarch64_vector_arithmetic_unary_cmp_int_lessthan_simd(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_arithmetic_unary_cmp_int_lessthan_sisd(
            Box::new(common::types::aarch64_vector_arithmetic_unary_cmp_int_lessthan_sisd_operands {
                d,
                n,
            }),
        ),
