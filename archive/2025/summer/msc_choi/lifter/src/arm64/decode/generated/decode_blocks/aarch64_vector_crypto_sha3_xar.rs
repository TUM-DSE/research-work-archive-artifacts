...
pub fn decode_aarch64_vector_crypto_sha3_xar(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_crypto_sha3_xar(
            Box::new(common::types::aarch64_vector_crypto_sha3_xar_operands {
                d,
                n,
            }),
        ),
