...
pub fn decode_aarch64_vector_arithmetic_binary_element_mul_acc_mul_norounding_i_lower(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_arithmetic_binary_element_mul_acc_mul_norounding_i_lower(
            Box::new(common::types::aarch64_vector_arithmetic_binary_element_mul_acc_mul_norounding_i_lower_operands {
                d,
                n,
            }),
        ),
