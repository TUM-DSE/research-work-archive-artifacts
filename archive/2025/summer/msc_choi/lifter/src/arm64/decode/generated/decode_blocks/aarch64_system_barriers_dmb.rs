...
pub fn decode_aarch64_system_barriers_dmb(
    ...
    Ok(
        common::types::Instruction::aarch64_system_barriers_dmb(
            Box::new(common::types::aarch64_system_barriers_dmb_operands {
            }),
        ),
    )
}
