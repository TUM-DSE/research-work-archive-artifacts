...
pub fn decode_aarch64_system_barriers_ssbb(
    ...
    Ok(
        common::types::Instruction::aarch64_system_barriers_ssbb(
            Box::new(common::types::aarch64_system_barriers_ssbb_operands {
            }),
        ),
    )
}
