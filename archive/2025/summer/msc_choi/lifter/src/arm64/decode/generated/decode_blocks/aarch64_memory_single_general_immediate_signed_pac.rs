...
pub fn decode_aarch64_memory_single_general_immediate_signed_pac(
    ...
    let W = common::types::bits::from_bits_literal(
    ...
    Ok(
        common::types::Instruction::aarch64_memory_single_general_immediate_signed_pac(
            Box::new(common::types::aarch64_memory_single_general_immediate_signed_pac_operands {
                n,
                t,
            }),
        ),
