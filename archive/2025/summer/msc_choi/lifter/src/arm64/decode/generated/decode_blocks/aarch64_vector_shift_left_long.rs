...
pub fn decode_aarch64_vector_shift_left_long(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_shift_left_long(
            Box::new(common::types::aarch64_vector_shift_left_long_operands {
                d,
                n,
            }),
        ),
