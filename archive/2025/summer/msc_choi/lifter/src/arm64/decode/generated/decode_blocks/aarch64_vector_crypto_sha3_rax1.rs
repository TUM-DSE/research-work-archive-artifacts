...
pub fn decode_aarch64_vector_crypto_sha3_rax1(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_crypto_sha3_rax1(
            Box::new(common::types::aarch64_vector_crypto_sha3_rax1_operands {
                d,
                n,
            }),
        ),
