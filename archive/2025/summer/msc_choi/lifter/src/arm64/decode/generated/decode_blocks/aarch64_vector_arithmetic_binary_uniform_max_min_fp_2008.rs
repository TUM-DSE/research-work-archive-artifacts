...
pub fn decode_aarch64_vector_arithmetic_binary_uniform_max_min_fp_2008(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_arithmetic_binary_uniform_max_min_fp16_2008(
            Box::new(common::types::aarch64_vector_arithmetic_binary_uniform_max_min_fp16_2008_operands {
                d,
                n,
            }),
        ),
