...
pub fn decode_aarch64_vector_crypto_sm4_sm4enckey(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_crypto_sm4_sm4enckey(
            Box::new(common::types::aarch64_vector_crypto_sm4_sm4enckey_operands {
                d,
                n,
            }),
        ),
