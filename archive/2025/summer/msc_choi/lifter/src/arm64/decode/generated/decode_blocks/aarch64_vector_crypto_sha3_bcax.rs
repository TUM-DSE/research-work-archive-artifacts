...
pub fn decode_aarch64_vector_crypto_sha3_bcax(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_crypto_sha3_bcax(
            Box::new(common::types::aarch64_vector_crypto_sha3_bcax_operands {
                d,
                n,
            }),
        ),
