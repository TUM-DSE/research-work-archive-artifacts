...
pub fn decode_aarch64_integer_arithmetic_div(
    ...
    Ok(
        common::types::Instruction::aarch64_integer_arithmetic_div(
            Box::new(common::types::aarch64_integer_arithmetic_div_operands {
                d,
                datasize,
                m,
                n,
