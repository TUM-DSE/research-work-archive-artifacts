...
pub fn decode_aarch64_vector_arithmetic_binary_uniform_mul_int_doubling_simd(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_arithmetic_binary_uniform_mul_int_doubling_sisd(
            Box::new(common::types::aarch64_vector_arithmetic_binary_uniform_mul_int_doubling_sisd_operands {
                d,
                n,
            }),
        ),
