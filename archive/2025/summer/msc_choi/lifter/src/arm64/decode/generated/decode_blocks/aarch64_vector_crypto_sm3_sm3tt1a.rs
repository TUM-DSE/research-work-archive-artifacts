...
pub fn decode_aarch64_vector_crypto_sm3_sm3tt1a(
    reader: &mut decode::BitReader,
) -> Result<common::types::Instruction, AArch64LifterError> {
    let Rm = common::types::bits::from_bits_literal(
        &reader.extract_slice(16usize, 5usize)?,
    )?;
    let imm2 = common::types::bits::from_bits_literal(
        &reader.extract_slice(12usize, 2usize)?,
    )?;
    ...
    Ok(
        common::types::Instruction::aarch64_vector_crypto_sm3_sm3tt1a(
            Box::new(common::types::aarch64_vector_crypto_sm3_sm3tt1a_operands {
                d,
                n,
            }),
        ),
