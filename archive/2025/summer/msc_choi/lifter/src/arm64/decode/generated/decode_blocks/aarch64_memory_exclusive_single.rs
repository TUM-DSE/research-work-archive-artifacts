...
pub fn decode_aarch64_memory_exclusive_single(
    ...
    Ok(
        common::types::Instruction::aarch64_memory_exclusive_single(
            Box::new(common::types::aarch64_memory_exclusive_single_operands {
                n,
                s,
                t,
                t2,
