...
pub fn decode_aarch64_memory_pair_simdfp_no_alloc(
    ...
    Ok(
        common::types::Instruction::aarch64_memory_pair_simdfp_no_alloc(
            Box::new(common::types::aarch64_memory_pair_simdfp_no_alloc_operands {
                n,
                t,
                t2,
            }),
