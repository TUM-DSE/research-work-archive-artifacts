...
pub fn decode_aarch64_vector_arithmetic_binary_uniform_max_min_single(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_arithmetic_binary_uniform_max_min_single(
            Box::new(common::types::aarch64_vector_arithmetic_binary_uniform_max_min_single_operands {
                d,
                n,
            }),
        ),
