...
pub fn decode_aarch64_integer_arithmetic_rev(
    ...
    let mut container_size: common::types::integer = common::types::integer::default();
    if (opc.match_with_pattern("00")) && true {
        decode::helpers::Unreachable_0()?;
    } else if (opc.match_with_pattern("01")) && true {
        container_size = common::types::integer::from(16);
    } else if (opc.match_with_pattern("10")) && true {
        container_size = common::types::integer::from(32);
        ...
        container_size = common::types::integer::from(64);
    }
    Ok(
        common::types::Instruction::aarch64_integer_arithmetic_rev(
            Box::new(common::types::aarch64_integer_arithmetic_rev_operands {
                container_size,
                d,
                datasize,
                n,
