...
pub fn decode_aarch64_vector_arithmetic_binary_uniform_cmp_int_simd(
    ...
    let eq = common::types::bits::from_bits_literal(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_arithmetic_binary_uniform_cmp_int_sisd(
            Box::new(common::types::aarch64_vector_arithmetic_binary_uniform_cmp_int_sisd_operands {
                d,
                n,
            }),
        ),
