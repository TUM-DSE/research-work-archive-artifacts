...
pub fn decode_aarch64_vector_transfer_integer_dup(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_transfer_integer_dup(
            Box::new(common::types::aarch64_vector_transfer_integer_dup_operands {
                d,
                n,
            }),
        ),
