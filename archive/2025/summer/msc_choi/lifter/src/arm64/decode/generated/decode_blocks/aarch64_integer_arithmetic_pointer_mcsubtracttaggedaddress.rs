...
pub fn decode_aarch64_integer_arithmetic_pointer_mcsubtracttaggedaddress(
    ...
    Ok(
        common::types::Instruction::aarch64_integer_arithmetic_pointer_mcsubtracttaggedaddress(
            Box::new(common::types::aarch64_integer_arithmetic_pointer_mcsubtracttaggedaddress_operands {
                d,
                n,
            }),
        ),
