...
pub fn decode_aarch64_vector_arithmetic_unary_rbit(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_arithmetic_unary_rbit(
            Box::new(common::types::aarch64_vector_arithmetic_unary_rbit_operands {
                d,
                n,
            }),
        ),
