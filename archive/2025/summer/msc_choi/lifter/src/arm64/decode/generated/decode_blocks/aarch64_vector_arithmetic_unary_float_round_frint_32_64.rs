...
pub fn decode_aarch64_vector_arithmetic_unary_float_round_frint_32_64(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_arithmetic_unary_float_round_frint_32_64(
            Box::new(common::types::aarch64_vector_arithmetic_unary_float_round_frint_32_64_operands {
                d,
                n,
            }),
        ),
