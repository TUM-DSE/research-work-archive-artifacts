...
pub fn decode_aarch64_vector_arithmetic_binary_uniform_mul_int_dotp(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_arithmetic_binary_uniform_mul_int_dotp(
            Box::new(common::types::aarch64_vector_arithmetic_binary_uniform_mul_int_dotp_operands {
                d,
                n,
            }),
        ),
