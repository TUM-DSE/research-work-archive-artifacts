...
pub fn decode_aarch64_integer_arithmetic_pointer_mcsubtracttaggedaddresssetflags(
    ...
    Ok(
        common::types::Instruction::aarch64_integer_arithmetic_pointer_mcsubtracttaggedaddresssetflags(
            Box::new(common::types::aarch64_integer_arithmetic_pointer_mcsubtracttaggedaddresssetflags_operands {
                d,
                n,
            }),
        ),
