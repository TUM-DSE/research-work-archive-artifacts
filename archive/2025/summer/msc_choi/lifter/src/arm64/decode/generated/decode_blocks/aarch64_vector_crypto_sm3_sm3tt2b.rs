...
pub fn decode_aarch64_vector_crypto_sm3_sm3tt2b(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_crypto_sm3_sm3tt2b(
            Box::new(common::types::aarch64_vector_crypto_sm3_sm3tt2b_operands {
                d,
                n,
            }),
        ),
