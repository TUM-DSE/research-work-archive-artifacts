...
pub fn decode_aarch64_vector_arithmetic_binary_uniform_mul_fp16_fused(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_arithmetic_binary_uniform_mul_fp16_fused(
            Box::new(common::types::aarch64_vector_arithmetic_binary_uniform_mul_fp16_fused_operands {
                d,
                n,
            }),
        ),
