...
pub fn decode_aarch64_vector_arithmetic_binary_disparate_add_sub_long(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_arithmetic_binary_disparate_add_sub_long(
            Box::new(common::types::aarch64_vector_arithmetic_binary_disparate_add_sub_long_operands {
                d,
                n,
            }),
        ),
