...
pub fn decode_aarch64_vector_arithmetic_binary_uniform_mul_int_accum(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_arithmetic_binary_uniform_mul_int_accum(
            Box::new(common::types::aarch64_vector_arithmetic_binary_uniform_mul_int_accum_operands {
                d,
                n,
            }),
        ),
