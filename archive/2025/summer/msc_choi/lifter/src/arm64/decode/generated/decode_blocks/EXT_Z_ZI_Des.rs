...
pub fn decode_EXT_Z_ZI_Des(
    reader: &mut decode::BitReader,
) -> Result<common::types::Instruction, AArch64LifterError> {
    let imm8h = common::types::bits::from_bits_literal(
        &reader.extract_slice(16usize, 5usize)?,
    )?;
    let imm8l = common::types::bits::from_bits_literal(
    ...
    Ok(
        common::types::Instruction::EXT_Z_ZI_Des(
            Box::new(common::types::EXT_Z_ZI_Des_operands {
                dn,
            }),
        ),
    )
