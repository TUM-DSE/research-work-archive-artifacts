...
pub fn decode_aarch64_vector_crypto_sha3_eor3(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_crypto_sha3_eor3(
            Box::new(common::types::aarch64_vector_crypto_sha3_eor3_operands {
                d,
                n,
            }),
        ),
