...
pub fn decode_aarch64_integer_arithmetic_add_sub_extendedreg(
    ...
    let mut shift: common::types::integer = decode::helpers::UInt_1(
        imm3,
        common::types::integer::from(3),
    )?;
    if (decode::helpers::gt_int_0(shift.clone(), common::types::integer::from(4))?)
        == common::types::boolean::TRUE
    {
    ...
    Ok(
        common::types::Instruction::aarch64_integer_arithmetic_add_sub_extendedreg(
            Box::new(common::types::aarch64_integer_arithmetic_add_sub_extendedreg_operands {
                d,
                datasize,
                extend_type,
                m,
