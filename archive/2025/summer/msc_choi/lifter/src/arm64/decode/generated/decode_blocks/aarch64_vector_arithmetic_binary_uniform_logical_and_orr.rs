...
pub fn decode_aarch64_vector_arithmetic_binary_uniform_logical_and_orr(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_arithmetic_binary_uniform_logical_and_orr(
            Box::new(common::types::aarch64_vector_arithmetic_binary_uniform_logical_and_orr_operands {
                d,
                n,
            }),
        ),
