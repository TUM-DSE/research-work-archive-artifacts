...
pub fn decode_aarch64_vector_shift_conv_int_sisd(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_shift_conv_int_sisd(
            Box::new(common::types::aarch64_vector_shift_conv_int_sisd_operands {
                d,
                n,
            }),
        ),
