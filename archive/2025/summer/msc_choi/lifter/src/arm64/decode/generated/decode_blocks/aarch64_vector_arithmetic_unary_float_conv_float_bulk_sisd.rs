...
pub fn decode_aarch64_vector_arithmetic_unary_float_conv_float_bulk_sisd(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_arithmetic_unary_fp16_conv_float_bulk_sisd(
            Box::new(common::types::aarch64_vector_arithmetic_unary_fp16_conv_float_bulk_sisd_operands {
                d,
                n,
            }),
        ),
