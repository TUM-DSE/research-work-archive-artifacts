...
pub fn decode_aarch64_vector_arithmetic_binary_uniform_add_halving_truncating(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_arithmetic_binary_uniform_add_halving_truncating(
            Box::new(common::types::aarch64_vector_arithmetic_binary_uniform_add_halving_truncating_operands {
                d,
                n,
            }),
        ),
