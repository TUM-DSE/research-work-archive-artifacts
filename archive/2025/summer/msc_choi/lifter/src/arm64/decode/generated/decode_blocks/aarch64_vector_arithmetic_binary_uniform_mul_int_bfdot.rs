...
pub fn decode_aarch64_vector_arithmetic_binary_uniform_mul_int_bfdot(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_arithmetic_binary_uniform_mul_int_bfdot(
            Box::new(common::types::aarch64_vector_arithmetic_binary_uniform_mul_int_bfdot_operands {
                d,
                n,
            }),
        ),
