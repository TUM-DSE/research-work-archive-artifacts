...
pub fn decode_aarch64_vector_arithmetic_binary_uniform_sub_fp16_simd(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_arithmetic_binary_uniform_sub_fp16_simd(
            Box::new(common::types::aarch64_vector_arithmetic_binary_uniform_sub_fp16_simd_operands {
                d,
                n,
            }),
        ),
