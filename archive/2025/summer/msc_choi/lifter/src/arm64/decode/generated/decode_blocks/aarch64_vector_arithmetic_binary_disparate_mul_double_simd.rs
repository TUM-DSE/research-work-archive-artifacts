...
pub fn decode_aarch64_vector_arithmetic_binary_disparate_mul_double_simd(
    ...
    Ok(
        common::types::Instruction::aarch64_vector_arithmetic_binary_disparate_mul_double_sisd(
            Box::new(common::types::aarch64_vector_arithmetic_binary_disparate_mul_double_sisd_operands {
                d,
                n,
            }),
        ),
