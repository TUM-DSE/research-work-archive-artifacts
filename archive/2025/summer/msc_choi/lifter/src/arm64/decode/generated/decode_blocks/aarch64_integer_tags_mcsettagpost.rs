...
pub fn decode_aarch64_integer_tags_mcsettagpost(
    ...
    Ok(
        common::types::Instruction::aarch64_integer_tags_mcsettagpost(
            Box::new(common::types::aarch64_integer_tags_mcsettagpost_operands {
                n,
                t,
            }),
        ),
