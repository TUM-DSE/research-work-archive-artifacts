...
pub fn decode_aarch64_float_arithmetic_round_frint(
    ...
    let rmode = common::types::bits::from_bits_literal(
        &reader.extract_slice(15usize, 3usize)?,
    )?;
    ...
    Ok(
        common::types::Instruction::aarch64_float_arithmetic_round_frint(
            Box::new(common::types::aarch64_float_arithmetic_round_frint_operands {
                d,
                n,
            }),
        ),
