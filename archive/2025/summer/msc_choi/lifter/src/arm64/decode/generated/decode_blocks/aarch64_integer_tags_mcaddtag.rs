...
pub fn decode_aarch64_integer_tags_mcaddtag(
    ...
    Ok(
        common::types::Instruction::aarch64_integer_tags_mcaddtag(
            Box::new(common::types::aarch64_integer_tags_mcaddtag_operands {
                d,
                n,
            }),
        ),
